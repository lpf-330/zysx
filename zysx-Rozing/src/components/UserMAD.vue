    ...
    <el-scrollbar height="3.5rem">
      <div class="MAD-header">
        ...
        <div class="decoration2"><img width="80%" height="80%"
            src="https://img.icons8.com/ios-filled/50/2D572D/capsule.png" alt="capsule" /></div>
      </div>
      ...
      <div class="detail">
        <div class="detail_image"><img width="100%" height="100%"
            src="https://img.icons8.com/ios-filled/50/2D572D/fine-print.png" alt="fine-print" /></div>
        <div>详细信息:</div>
      </div>
