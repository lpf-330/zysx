...
.personal-info-container {
  ...
  box-shadow: 0 4px 20px rgba(45, 87, 45, 0.08);
  max-width: 100%;
  margin: auto;
...
.info-card-header {
  ...
  border-radius: 0.1rem;
  padding: 0.15rem;
  border: 0.01rem solid #81C784;
  box-shadow: 0 0.025rem 0.1rem rgba(45, 87, 45, 0.06);
}
...
.confirm {
  ...
  font-size: 0.1rem;
  font-family: 'FanYuanTi';
  --el-button-bg-color: #2D572D;
  --el-button-border-color: #2D572D;
  --el-button-hover-bg-color: #3d7a3d;
  --el-button-hover-border-color: #3d7a3d;
  --el-button-active-bg-color: #1a3d1a;
  --el-button-active-border-color: #1a3d1a;
}

:deep(.custom-message) {
  font-family: 'FanYuanTi', sans-serif;
  border-radius: 12px !important;
  box-shadow: 0 6px 20px rgba(45, 87, 45, 0.15) !important;
...
:deep(.custom-message.el-message--success) {
  background: linear-gradient(135deg, #f0f9f0, #e6f7e6) !important;
  border: 1px solid #81C784 !important;
  color: #2D572D !important;
}
