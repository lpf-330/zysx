<template>
    ...
    <el-scrollbar height="3.5rem">
        <div class="MAD-header">
            ...
            <span>用药依从性记录</span>
            <div class="decoration2"><img width="80%" height="80%" src="https://img.icons8.com/ios-filled/50/228BE6/capsule.png" alt="capsule"/></div>
        </div>
        <div class="decoration3"></div>
        <div class="derection">
            <div class="decoration4"><img width="100%" height="100%" src="https://img.icons8.com/fluency/48/help--v1.png" alt="help--v1"/></div>
                <div class="y_or_n">
              ...
              <div class="detail">
                <div class="detail_image"><img width="100%" height="100%" src="https://img.icons8.com/ios-filled/50/228BE6/fine-print.png" alt="fine-print"/></div>
                <div>详细信息:</div>
              </div>
                <div class="detail_span_content">
                  <span class="detail-content">阿司匹林 80mg 1次/天，每周一次，服用频率：每天一次，服用时间：2周，服用方式：口服，服药后出现头痛、恶心、呕吐、腹泻等症状，请及时就医。布洛芬 20mg 1次 1天 口服，服药后出现头痛、恶心、呕吐，请及时就医（有则填写，无则不填）</span>
                </div>
    </el-scrollbar>
    </div>
</template>
