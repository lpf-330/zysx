      ...
      <div class="flex-container">
       ...
       <div class="profile">
        ...
        <div class="Modification">
          <span @click="props.openEditDrawer">去编辑</span>
          <el-button type="primary" class="Edit-btn" @click="props.openEditDrawer" :icon="Edit" circle></el-button>
        </div>
      </div>
    </div>
  </div>
...
.gender {
  ...
  background-color: rgba(45, 87, 45, 0.6);
  box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.1);
}
